...
chatSections.forEach(chatSection => {
    const userList = chatSection.querySelector("#userList");
    const chatTitle = chatSection.querySelector("#chatTitle");
    ...
    const chatWindow = chatSection.querySelector(".chat-window");
    const right = chatSection.querySelector(".right_btn");
